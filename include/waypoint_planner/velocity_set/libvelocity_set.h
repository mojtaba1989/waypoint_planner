...
#ifndef WAYPOINT_PLANNER_VELOCITY_SET_LIBVELOCITY_SET_H
#define WAYPOINT_PLANNER_VELOCITY_SET_LIBVELOCITY_SET_H
...
#endif  // WAYPOINT_PLANNER_VELOCITY_SET_LIBVELOCITY_SET_H
